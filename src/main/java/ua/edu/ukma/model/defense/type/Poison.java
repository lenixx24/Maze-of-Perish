...
public class Poison extends EffectZone {
    ...
    public Poison(int row, int col) {
        super(row, col, DefenseType.POISON_CLOUD,  1.5, 100.0, 50.0);
        this.viewGroup = new Group();
        this.viewGroup.setMouseTransparent(true);

        Image mainTexture = new Image(DefenseType.POISON_CLOUD.texturePath());
        Image zoneTexture = new Image("/defense/poison1.png");
